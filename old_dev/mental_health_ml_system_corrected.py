"""
🧠 Mental Health Prediction System - ACTUAL ML IMPLEMENTATION
==============================================================
...
print(Fore.CYAN + Style.BRIGHT + "🧪 Testing Mental Health Prediction System with REAL ML Model...")
...
class MentalHealthPredictor:
    ...
    def create_synthetic_data(self):
        ...
        data = {
            ...
            'anxiety_score': np.random.randint(0, 22, n_samples),
    ...
    def prepare_features(self, df):
        ...
        print(Fore.GREEN + f"✅ Model trained successfully! Accuracy: {accuracy:.3f}")
...
## Model Performance
- **Accuracy**: {'N/A' if not predictor.is_trained else f'{accuracy_score(predictor.y_test, predictor.model.predict(predictor.X_test)):.3f}'}
- **Features Used**: {len(predictor.feature_columns)} demographic and clinical factors
- **Training Samples**: {'N/A' if not predictor.is_trained else len(predictor.X_test)}
