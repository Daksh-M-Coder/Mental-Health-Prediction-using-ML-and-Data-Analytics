"""
🧠 Mental Health Prediction System - FINAL CLEAN VERSION WITH IMPROVED LAYOUT
==============================================================================
...
1. **Decision Tree Classifier**
   - Interpretable model that creates decision rules
...
3. **K-Nearest Neighbors (KNN)**
   ...
   - Makes predictions based on similarity to training instances
   - Non-parametric, works well with small datasets
...
- Models are trained on mental health dataset
- Performance is evaluated using cross-validation
- Best performing model is selected based on accuracy, precision, recall, and F1-score
- Final model is used for predictions with confidence intervals

### Model Training Features:
- Demographics: Age, Gender
- Employment: Status, Work Environment
- Clinical Scores: Depression, Anxiety, Stress
- Lifestyle: Sleep, Physical Activity, Social Support
- Behavioral: Productivity, Treatment History

All models are trained to predict:
- Mental Health Risk Level (Low/Medium/High)
- Treatment Seeking Likelihood
- Symptom Severity Scores
- Intervention Response Potential
""")
