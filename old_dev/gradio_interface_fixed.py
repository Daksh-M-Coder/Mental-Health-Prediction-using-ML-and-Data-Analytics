"""
🧠 Mental Health Prediction System - FIXED Gradio Interface
==========================================================

Fixed implementation with:
- Working sample cases
- Proper explanation card loading
- Better UI design
- Error handling
"""
...
try:
    ...
    explanation_cards = {
        7: "# Model Explanation Guide\n\nDetailed explanations for all predictions...",
        8: "# Risk Classification Reference\n\nLow/Medium/High risk definitions...",
        9: "# Treatment Seeking Guide\n\nWhen and why treatment is recommended...",
...
def get_explanation_card(card_selection: str) -> str:
    """Retrieve specific explanation card"""
    # Extract number from selection string
    try:
        card_number = int(card_selection.split('.')[0])
        ...
        logger.error(f"Error parsing card selection: {e}")
...
def create_gradio_interface():
    ...
    with gr.Blocks(css=custom_css, title="Mental Health Prediction System") as demo:
        ...
        with gr.Tab("📚 Explanation Cards"):
            ...
            with gr.Row():
                card_selector = gr.Dropdown(
                    ...
                    value="7. Model Explanation Guide"
                )
        ...
        demo.load(
            fn=lambda: get_explanation_card("7. Model Explanation Guide"),
            inputs=[],
            outputs=[card_display]
        )
